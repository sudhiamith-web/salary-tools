...
export const metadata: Metadata = {
  title: "WorkTools — Salary, tax and HR calculators for India",
  description:
      ...
      >
        <header className="border-b border-ink/10 bg-paper">
          <div className="mx-auto max-w-6xl px-6 py-4 flex items-center justify-between">
            <Link href="/" className="font-display text-xl text-ink">
              WorkTools<span className="text-ledger">.</span>
            </Link>
        ...
        <footer className="border-t border-ink/10 mt-24">
          <div className="mx-auto max-w-6xl px-6 py-10 text-xs text-charcoal/50">
            WorkTools is an independent project and is not affiliated with any
            employer, government body, or tax authority. Figures are
